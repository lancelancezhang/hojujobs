...
export const REGION_GROUPS: RegionGroup[] = [
  {
    region: "시드니 CBD / 이너시티",
    suburbs: ["시드니 CBD", "시드니", "시드니 시티", "써리힐즈", "패딩턴", "피어몬트", "팟츠포인트", "헤이마켓", "킹스크로스", "치펜데일", "레드펀", "울티모", "글리브", "시드니 전역"],
  },
  {
    region: "이너웨스트",
  ...
  {
    region: "사우스웨스트",
    suburbs: ["허스트빌", "사우스 허스트빌", "울루웨어", "벨모어", "뱅스타운", "캠벨타운", "리버풀", "리버우드", "미란다", "홀슬리파크", "로즈랜즈", "리전트파크"],
  },
  {
    region: "웨스트 / 파라마타",
    suburbs: ["파라마타", "스트라스필드", "실버워터", "어밍턴", "라이달미어", "웬트워스포인트", "뉴잉턴", "뉴잉톤", "리드컴", "노스스트라스필드", "통가비", "노스미드"],
  },
  {
    region: "노스웨스트 / 힐스",
    suburbs: ["노웨스트", "버큼힐", "페넌트힐즈", "라우스 힐", "라우즈힐", "마운트드루잇", "펜리스", "캐슬힐", "켈리빌", "스탠호프 가든스", "체리브룩"],
  },
  {
    region: "노스쇼어",
    suburbs: ["노스 시드니", "노스시드니", "체스우드", "채스우드", "고든", "혼스비", "세인트 아이브스", "세인트아이브스", "모스만", "레인코브", "세인트레너즈", "터라머라", "애스퀴스", "아타몬", "롱빌"],
  },
  {
    region: "라이드 / 맥쿼리",
    suburbs: ["라이드", "웨스트 라이드", "웨스트라이드", "이스트라이드", "이스트우드", "에핑", "메도우뱅크", "매도뱅크", "맥쿼리", "맥쿼리파크", "톱라이드", "탑라이드"],
  },
  {
    region: "비치 / 노스",
