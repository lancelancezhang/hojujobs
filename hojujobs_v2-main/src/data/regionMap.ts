...
export const REGION_GROUPS: RegionGroup[] = [
  {
    region: "시드니 CBD",
    suburbs: ["시드니 CBD", "시드니", "시드니 시티", "헤이마켓", "킹스크로스", "팟츠포인트", "써리힐즈", "피어몬트", "치펜데일", "레드펀", "울티모", "글리브", "시드니 전역"],
  },
  {
    region: "이너웨스트",
    suburbs: ["뉴타운", "스트라스필드", "버우드", "캠시", "마릭빌", "라이카트", "콩코드", "로즈", "파이브독", "애보츠포드", "발메인", "시드넘", "노스스트라스필드"],
  },
  {
    region: "라이드 / 이스트우드",
    suburbs: ["라이드", "이스트우드", "에핑", "웨스트 라이드", "웨스트라이드", "메도우뱅크", "매도뱅크", "이스트라이드", "맥쿼리", "맥쿼리파크", "톱라이드", "탑라이드"],
  },
  {
    region: "파라마타 / 웨스트",
    suburbs: ["파라마타", "실버워터", "리드컴", "뉴잉턴", "뉴잉톤", "어밍턴", "라이달미어", "웬트워스포인트", "통가비", "노스미드"],
  },
  {
    region: "힐스 지구",
    suburbs: ["노웨스트", "켈리빌", "라우스 힐", "라우즈힐", "스탠호프 가든스", "체리브룩", "캐슬힐", "버큼힐", "페넌트힐즈", "마운트드루잇", "펜리스"],
  },
  {
    region: "채스우드 / 노스 시드니",
    suburbs: ["채스우드", "체스우드", "노스 시드니", "노스시드니", "세인트레너즈", "아타몬", "레인코브", "모스만", "롱빌"],
  },
  {
    region: "어퍼 노스쇼어",
    suburbs: ["혼스비", "세인트 아이브스", "세인트아이브스", "고든", "터라머라", "애스퀴스", "패딩턴"],
  },
  {
    region: "노던 비치",
    suburbs: ["워리우드", "맨리", "엘라노라하이츠"],
  },
  {
    region: "세인트조지 / 서더랜드",
    suburbs: ["허스트빌", "사우스 허스트빌", "미란다", "울루웨어", "리버우드", "로즈랜즈"],
  },
  {
    region: "사우스웨스트",
    suburbs: ["캠벨타운", "리버풀", "뱅스타운", "벨모어", "리전트파크", "홀슬리파크"],
  },
  {
    region: "사우스 시드니",
    suburbs: ["마스콧", "알렉산드리아", "워터루", "그린스퀘어", "월리크릭", "힐스데일", "이스트레이크스", "쿠지비치", "본다이"],
  },
  {
    region: "센트럴 코스트",
    suburbs: ["센트럴 코스트"],
